...
////    success &= pca9685_set_pwm_frequency(handle, 50); // use 50 Hz for Servos
...
//		}
//
//		// Offset on and off times depending on channel to minimize current spikes.
